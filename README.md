...
|--------|--------|--------|--------|------|
| **Sprint 1** | Weeks 2–4 | Setup and Core Features | Create GitHub repo and file structure<br> Build homepage and map interface (Google Maps or Mapbox API sounds good)<br> Add search function for conventions<br> Display convention markers on the map<br>• Store basic data in JSON or database | Have a working prototype that shows conventions and distance from the user. |
| **Sprint 2** | Weeks 5–7 | Enhancements and Integration | Add travel cost estimation (car and flight)<br> Include nearby hotel listings<br>• Show attendance from previous year<br>• Improve mobile design<br> Conduct testing and fix bugs | A working version ready for demo with realistic data and smooth performance. |
